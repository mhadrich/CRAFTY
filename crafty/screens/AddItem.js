  ...
  return (
    <View className="w-screen h-screen px-4 items-start dark:bg-[#111111]">
      <ScrollView showsVerticalScrollIndicator={false}>
        <Text className="text-lg mb-2 font-semibold leading-snug dark:text-white">Name</Text>
        <TextInput
        ...
        >
          <Text className="text-sm dark:text-white">{cat ? cat : "Pick a category"}</Text>
        </TouchableOpacity>
        <Text className="text-lg mb-2 font-semibold leading-snug dark:text-white">Tags</Text>
        <TextInput
          className="mb-4 w-full h-16 pl-3 bg-white dark:bg-[#333333] dark:text-white rounded-md shadow"
        ...
        />
        <Text className="text-lg mb-2 font-semibold leading-snug dark:text-white">Price</Text>
        <TextInput
          className="mb-4 w-full h-16 pl-3 bg-white dark:bg-[#333333] dark:text-white rounded-md shadow"
          keyboardType="numeric"
          placeholder={"Price"}
        />
        <View className="w-32 h-32 items-center justify-center bg-white dark:bg-[#333333] rounded shadow">
